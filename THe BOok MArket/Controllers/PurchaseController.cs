...
namespace THe_BOok_MArket.Controllers
{
    public class PurchaseController : Controller
    {
        ...
        {
            var purchases = db.Purchases.Include(p => p.Book_Supplier);
        ...
        public ActionResult Create([Bind(Include = "Purchase_ID,Purchase_Amount,Purchase_Date,BookSupplier_ID")] Purchase purchase)
        {
